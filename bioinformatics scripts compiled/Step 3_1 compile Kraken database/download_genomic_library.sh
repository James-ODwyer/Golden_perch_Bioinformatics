...
# Base kraken script largely works but it's calls to NCBI are outdated. 
# This new compiled script just updates the NCBI based calls to allow for downloading of the bacterial sequences
